...
url = 'https://keydstool.000webhostapp.com/API/keyds.php?key='+key
token_link1s = 'ac3fd05a823ca277a88a2ce863ce136966708725'
        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(Colorate.Horizontal(Colors.purple_to_red, f'Buff Thành Công==>| success: {success} fails: {fails} reqs: {reqs} rps: {rps} rpm: {rpm}'))
                    success += 1
                    _lock.release()
            except:
...
if __name__ == "__main__":
    ...
    set_title("Key-Ds Tool")
    txt = """\n\n
    Tool Buff View Tik Tok By Key-Ds Tool \n"""
    print(
        Colorate.Vertical(
